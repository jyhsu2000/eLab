 ...
 * @property int|null $start_date 開始日
 * @property int|null $end_year 結束年
 * @property int|null $end_month 結束月
 * @property int|null $end_date 結束日
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\JobExperience whereEndDate($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\JobExperience whereStartDate($value)
