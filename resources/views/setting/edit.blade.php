...
@section('main_content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            {{ bs()->formGroup(bs()->text('lab_name')->placeholder('顯示於左上角及頁尾，如：ISLab'))->label('實驗室簡稱')->showAsRow() }}
            {{ bs()->formGroup(bs()->text('lab_full_name')->placeholder('顯示於首頁，如：逢甲大學資訊安全實驗室'))->label('實驗室全名')->showAsRow() }}
        </div>
        <div class="card-body">
